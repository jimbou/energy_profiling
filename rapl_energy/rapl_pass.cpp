        ...
        for(Module::iterator F = M.begin(), E = M.end(); F!= E; ++F)
        {
            ...
            for(Function::iterator BB = F->begin(), E = F->end(); BB != E; ++BB)
            {
                   ...
                   /*for (BasicBlock::iterator i = BB->begin(), e = bb->end(); i != e; ++i) {
                    ...
                    Instruction *newInst0 = CallInst::Create(raplread, "");
                    BB->getInstList().insert(BI, newInst0); 
                    Instruction *newInst1 = CallInst::Create(raplread, "");
                    BB->getInstList().insert(BF, newInst1); 
